...
def model_prediction(test_image):
    model = tf.keras.models.load_model("trained_plant_disease_model10.keras")
    image = tf.keras.preprocessing.image.load_img(test_image, target_size=(128, 128))  # Resize the image
...
# Prediction Page
    ...
    if st.button("Show Image"):
       st.image(test_image, width=128, use_column_width=False)  # Display the uploaded image
    # Predict button
